...
let object1 = {
  ...
  theCode: 67,
  display: function () {
    image(bannana, this.x, this.y, 70, 70);
...
let object2 = {
  ...
  theCode: 82,
  display: function () {
    image(can, this.x, this.y, 100, 100);
  },
};
...
let object3 = {
  ...
  theCode: 82,
  display: function () {
    image(glassbottle, this.x, this.y, 70, 70);
  },
};
...
let object4 = {
  ...
  theCode: 67,
  display: function () {
    image(leaves, this.x, this.y, 70, 70);
  },
};
let object5 = {
  on: true,
  ...
  theCode: 76,
  display: function () {
    image(pizzabox, this.x, this.y, 70, 70);
  },
};
let object6 = {
  on: true,
  ...
  theCode: 82,
  display: function () {
    image(plasticbottle, this.x, this.y, 70, 70);
  },
};
let object7 = {
  on: true,
  ...
  theCode: 76,
  display: function () {
    image(plasticbag, this.x, this.y, 70, 70);
  },
};
let object8 = {
  on: true,
  ...
  theCode: 76,
  display: function () {
    image(styrofoam, this.x, this.y, 70, 70);
  },
};
let object9 = {
  on: true,
  ...
  theCode: 67,
  display: function () {
    image(veggies, this.x, this.y, 70, 70);
  },
};
